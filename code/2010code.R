...
Data<-read_xls('/Users/mli0316/Desktop/UConn/stat 5225/group proj/raw data/2010.xls',skip = 3)
...
#colnames(Data)[c(7)] <- c("Forciblerape")
#colnames(Data)[c(9)] <- c("Aggravatedassault")
#colnames(Data)[c(12)] <- c("Larcenytheft")
#colnames(Data)[c(13)] <- c("Motorvehicletheft")
...
write.csv(Data2010_Part1,"/Users/mli0316/Desktop/UConn/stat 5225/group proj/raw data/Data2010_Part1.csv", row.names = FALSE)
write.csv(Data2010_Part2,"/Users/mli0316/Desktop/UConn/stat 5225/group proj/raw data/Data2010_Part2.csv", row.names = FALSE)
