...
Data<-read_xls('/Users/mli0316/Desktop/UConn/stat 5225/group proj/raw data/2018.xls',skip = 3)
...
### remove the last 2 columns which are not useful
...
dt11 <- 
  ...
  select(-ViolentCrime, -Murderandnonnegligentmanslaughter, -Rape2,-Robbery,
...
Data2018_Part2 <- 
  ...
  select(-Population, -ViolentCrime2, -Murderandnonnegligentmanslaughter2, -Rape22,
         -Robbery2, -Aggravatedassault2, -PropertyCrime2, -Burglary2, -Larcenytheft2, -Motorvehicletheft2)


write.csv(Data2018_Part1,"/Users/mli0316/Desktop/UConn/stat 5225/group proj/raw data/Data2018_Part1.csv", row.names = FALSE)
write.csv(Data2018_Part2,"/Users/mli0316/Desktop/UConn/stat 5225/group proj/raw data/Data2018_Part2.csv", row.names = FALSE)
