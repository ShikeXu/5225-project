...
Data2007<-read_xls('/Users/mli0316/Desktop/UConn/stat 5225/group proj/raw data/2007.xls',skip = 3)
Data2007$State <- gsub('[0-9,]','',Data2007$State)
colnames(Data2007)<-gsub('[^A-Za-z]','',colnames(Data2007))

### rename incorrect colnames
colnames(Data2007)[c(3)] <- c("Actual")

### remove the last column which is not useful
Data2007 <- Data2007[, -ncol(Data2007)]


# Check categories of column actual
table(Data2007$Actual)
table(Data2007$Area)
...
write.csv(Data2007_Part1,"/Users/mli0316/Desktop/UConn/stat 5225/group proj/raw data/Data2007_Part1.csv", row.names = FALSE)
write.csv(Data2007_Part2,"/Users/mli0316/Desktop/UConn/stat 5225/group proj/raw data/Data2007_Part2.csv", row.names = FALSE)
