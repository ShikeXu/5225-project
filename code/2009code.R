...
Data2009<-read_xls('/Users/mli0316/Desktop/UConn/stat 5225/group proj/raw data/2009.xls',skip = 3)
Data2009$State <- gsub('[0-9,]','',Data2009$State)
colnames(Data2009)<-gsub('[^A-Za-z]','',colnames(Data2009))

### rename incorrect colnames
colnames(Data2009)[c(3)] <- c("Actual")

### remove the last column which is not useful
Data2009 <- Data2009[, -ncol(Data2009)]


# Check categories of column actual
table(Data2009$Actual)
table(Data2009$Area)
...
write.csv(Data2009_Part1,"/Users/mli0316/Desktop/UConn/stat 5225/group proj/raw data/Data2009_Part1.csv", row.names = FALSE)
write.csv(Data2009_Part2,"/Users/mli0316/Desktop/UConn/stat 5225/group proj/raw data/Data2009_Part2.csv", row.names = FALSE)
