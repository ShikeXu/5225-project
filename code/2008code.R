...
Data2008<-read_xls('/Users/mli0316/Desktop/UConn/stat 5225/group proj/raw data/2008.xls',skip = 3)
Data2008$State <- gsub('[0-9,]','',Data2008$State)
colnames(Data2008)<-gsub('[^A-Za-z]','',colnames(Data2008))

### rename incorrect colnames
colnames(Data2008)[c(3)] <- c("Actual")

### remove the last column which is not useful
Data2008 <- Data2008[, -ncol(Data2008)]


# Check categories of column actual
table(Data2008$Actual)
table(Data2008$Area)
...
write.csv(Data2008_Part1,"/Users/mli0316/Desktop/UConn/stat 5225/group proj/raw data/Data2008_Part1.csv", row.names = FALSE)
write.csv(Data2008_Part2,"/Users/mli0316/Desktop/UConn/stat 5225/group proj/raw data/Data2008_Part2.csv", row.names = FALSE)
