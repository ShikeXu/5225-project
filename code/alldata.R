...
for(i in 1999:2002){
  path1 <- paste0("../raw data/Data",i, "_Part1.csv")
  dt1 <-  read.csv(file = path1, header = TRUE, skip=1) 
...
for(i in 1999:2019){
  path2 <- paste0("C:/Users/sirius/Desktop/group assignment/data????????/Data",i, "_Part2.csv")
...
write.csv(alldata_Part1,'../raw data/alldata_Part1.csv')
write.csv(alldata_Part2,'../raw data/alldata_Part2.csv')
