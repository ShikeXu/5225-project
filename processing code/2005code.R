...
Data<-read_xls('/Users/mli0316/Desktop/UConn/stat 5225/group proj/raw data/2005.xls',skip = 3)
...
Data2005_Part2 <- 
  ...
  select(-Population, -ViolentCrime2, -Murderandnonnegligentmanslaughter2, -Forciblerape2,
         -Robbery2, -Aggravatedassault2, -PropertyCrime2, -Burglary2, -Larcenytheft2, -Motorvehicletheft2)


write.csv(Data2005_Part1,"/Users/mli0316/Desktop/UConn/stat 5225/group proj/raw data/Data2005_Part1.csv", row.names = FALSE)
write.csv(Data2005_Part2,"/Users/mli0316/Desktop/UConn/stat 5225/group proj/raw data/Data2005_Part2.csv", row.names = FALSE)
